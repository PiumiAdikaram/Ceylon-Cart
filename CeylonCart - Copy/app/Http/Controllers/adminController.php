...
class adminController extends Controller
{
    ...
    public function viewprofile(){
        $title = 'Admin - Profile';
        $adminData = DB::select('select * from admins where id=1');
...
//******************************************************************************************************************** */
    ...
    public function updateprofile(Request $request)
    {
        ...
        $query=DB::update("update admins set accountNo = '$accountNo', name = '$name', nic = '$nic', email = '$email', phoneNo = '$phoneNo' where adminId = $userId");
